...
*Once the pandemic hits, things started to get more serious (since there was nothing else to do).*
...
<center>
![](images/livio.jpg){ width=60% height=60% }
<center>
...
<center>
![](images/mercier.jpg){ width=60% height=60% }
<center>
...
What do you do with your wine boxes?

$$\\[0.1cm]$$

<center>
![](images/winey.jpg){ width=60% height=60% }
<center>
...
One of those bikes you build for you cause you like the frame colors - but everyone else also likes so it gets away from you ...

$$\\[0.1cm]$$

<center>
![](images/pinky.jpg){ width=60% height=60% }
<center>
...
My dad’s first ever bike. This project started with 1970/1980s Mazza frame, made in Geneva. The old paint off was stripped for a bare metal finish. The bike was assembled with a period correct Shimano 600 groupset - with a few old school mods in handlebars and shifters for comfort.
...
All original 1980s De Rosa Professional with full Campagnolo Chorus groupset (including the pedals, straps, and water bottle). This one I bought it from the original owner in great shape, it was custom built for him by a certain Hugo (de Rosa). But guess what? We are the same height, so perfect fit for me! It cleaned up great for its' age, did it not?
...
Only the best neighbors get BFF bikes! This one was built for one of our coolest neighbors from a 1980s Vitus frame and more modern components to be the perfect hybrid commuter bike (and super light), capable bike to ride around town or go on longer rides!
...
I know I said I don't like gravel bikes and that they are stupid, but I take it all back! This is a 1995 custom made Atala frame built with period correct Campagnolo Chorus 9 speed groupset with a twist - a set of hand-built 650b rims (and long reach brakes). This allows me to fit 38 mm tires and have the prettiest gravel bike around - jealous?
...
My father-in-law needed (at least I felt like he needed) a new bike to go around the block and get some groceries. So using everything I had around the house, I "patchworked" him a cool new ride! Would you get your groceries on this?
