...
tribble(~ Title, ~ Published, ~ Journal, ~ When,
        "Radiating Truthiness: Authenticity performances in politics in Brazil and the United States", "Forthcoming", "Political Studies", "2024",
...
tribble(~ What, ~ When, ~ With, ~ Where, ~ Why,
        "Research Assistant",
        "Sep 2020 - Present","Centre for International Environmental Studies", "Geneva, Switzerland",
        "Assist with the theoretical, methodological, and empirical developments for comparing various issue-domains of global governance in the PANARCHIC project, funded by the Swiss National Science Foundation
        \\item Support the development of data infrastructure and statistical methods in R for gathering, consolidating, and analyzing global governance data
        ...
        \\item Communicated with coaches, children, and parents to cordinate and solve logistical issues related to transportation, venue organization, delivery of supplies, medical emergencies, and other unexpected events that arose") %>%
