...
tribble(~ Degree, ~ Year, ~ Institution, ~ Where, ~ Why,
  "Doctorate in International Relations and Political Science",
  "Sep 2019 -  2024",
  "The Graduate Institute of International and Development Studies (IHEID)", 
  "Geneva, Switzerland",
  "\\textit{Doctoral Project:} 'Authenticity, problem construction, and urgency in political discourses' \\\\ Supervised by Dr. James Hollway and Dr. Yanina Welp
  \\item \\textit{Core Courses:} Doctoral Seminar; Survey Experiments; Social Networks; Statistics; Identity and Violence",
  "Masters in International Relations and Political Science",
  "Sep 2017 - Aug 2019",
  "The Graduate Institute of International and Development Studies (IHEID)",
  "Geneva, Switzerland",
  "\\textit{Masters' Thesis:} 'The Construction of a Migrant Crisis - The Venezuelan Migration to Brazil' \\\\ Supervised by Dr. Melanie Kolbe and Dr. Graziella Moraes Silva",
  ...
  "\\textit{Awards:} Recipient of 4 years of scholarship as a Student-Athlete for Soccer in a NCAA Division 1 University") %>% 
...
```{r}
tribble(~ Title, ~ Published, ~ Journal, 
  "Which Amazon Problem? Problem-constructions and Transnationalism in Brazilian Presidential Discourse since 1985 (with Livio Silva-Muller)",
  "\\href{https://www.tandfonline.com/doi/full/10.1080/09644016.2023.2220639}{DOI: 10.1080/09644016.2023.2220639}", "Environmental Politics",
  ...
  "Working Paper", "") %>% 
  detailed_entries(where = Journal, with = Title, what = Published,
                   .protect = FALSE)
```
...
tribble(~ Course, ~ Where, ~ Date, ~ Why, 
  ...
  "The Graduate Institute of International and Development Studies (IHEID)",
  "Fall 2022, Spring 2023, Fall 2023 (upcoming)",
...
tribble(~ Name, ~ Purpose, ~ Status,
        ...
        "An R portal for global governance data",
        "Contributor",
        "\\href{https://globalgov.github.io/messydates/}{messydates}",
        "An R package for Extended Date/Time Format (EDTF)",
        "Contributor",
        "\\href{https://snlab-ch.github.io/manynet/}{manynet}",
        "An R package to make, manipulate, and map myriad networks",
        "Contributor",
        "\\href{https://snlab-ch.github.io/migraph/}{migraph}",
        "An R package with tools for multimodal and multilevel network analysis", 
        "Contributor",
        "\\href{https://globalgov.github.io/manypkgs/}{manypkgs}",
        "An R package to support the creation of new many packages",
        "Contributor",
        "\\href{https://globalgov.github.io/manyenviron/}{manyenviron}",
        "An R data package on environmental agreements",
        "Contributor",
        "\\href{https://globalgov.github.io/manystates/}{manystates}",
        "An R data package on sovereign states",
        "Contributor",
        "\\href{https://github.com/henriquesposito/poldis}{poldis}",
        "An R package with tools for analyzing political discourses over time", 
        "Author") %>%
  detailed_entries(what = Purpose, with = Name, when = Status,
                   .protect = FALSE)
```
...
tribble(~ Name, ~ Position, ~ Contact,
        ...
        "Associate Professor of International Relations and Political Science at the Graduate Institute of International and Development Studies (IHEID)",
