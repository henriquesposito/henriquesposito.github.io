...
Political statements are regular sources of politicians' preferences and plans. The urgency with which a politician talks about their preferences and plans communicates important information about what they should pursue first, most strongly, or with most energy or commitment. In political statements, urgency is an expression of how necessary or how soon an action should be undertaken or completed. In this paper, we examine the ‘urgency’ of future promises in political discourse. To do so, we develop a new method to extract and rank  the intent for action to be taken from political discourses, namely urgency analysis. Urgency analysis employs a combination of Natural Language Processes (NLP) and dictionary approaches to provide a localized (section and issue specific), normalized (comparable by default), and inclusive (accounts for metadata related to setting and timing) new method for the analysis of political texts. Urgency analysis is implemented for R with the [poldis](https://github.com/henriquesposito/poldis) package, making it an easy, free, and accessible tool for researchers interested in analyzing political discourses. The package includes additional tools to visualize and compare results.
