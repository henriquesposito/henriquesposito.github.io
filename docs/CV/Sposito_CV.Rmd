...
tribble(~ Title, ~ Published, ~ Journal, ~ When,
  ...
  "How urgently do leaders speak about climate change? Urgency analysis of political priorities (with Jael Tan and James Hollway)",
  "Working Paper", "", "",
...
tribble(~ What, ~ When, ~ With, ~ Where, ~ Why,
        ...
        "Bern, Switzerland",
        "Engages in the research, design, and formulation of innovative and sustainable governance solutions for people and nature",
        "Research Assistant",
...
```{r}
tribble(~ Title, ~ Published, ~ Journal, ~ When,
        "\\href{https://globalchallenges.ch/issue/16/the-politics-in-anti-politically-correct-discourses/}{The politics in anti-politically correct discourses}", "Issue 16 - Elections, What For?", "Global Challenges", "November 2024") %>% 
  detailed_entries(where = Journal, with = Title, what = Published, when = When,
                   .protect = FALSE)
```
