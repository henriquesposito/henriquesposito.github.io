...
\textbf{Interests:} Political Sociology, Environmental Studies, Statistical Methods, Text Analysis, Comparative Politics
...
# tribble(~ What, ~ When, ~ With, ~ Where, ~ Why,
#         "Research Assistant", "Sep 2020 - Present", "Centre for International Environmental Studies", "Geneva, Switzerland",
#         "Assist with the theoretical, methodological, and empirical developments in data and analysis for across various domains of global governance in the 'PANARCHIC: Power and Networks and the Rate of Change in Institutional Complexes' project funded by the Swiss National Science Foundation
#         \\begin{itemize}
...
tribble(~ Course, ~ Where, ~ Date, ~ Why, 
  "Fundamentals of R (co-lecturer with Livio Silva-Muller)",
  "The Graduate Institute of International and Development Studies",
...
tribble(~ Name, ~ Purpose, ~ Status,
        ...
        "\\href{https://globalgov.github.io/messydates/}{An R package for Extended Date/Time Format}",
        "Contributor",
...
\center{\textit{Additional references available upon request.}}