...
tribble(~ Degree, ~ Year, ~ Institution, ~ Where, ~ Why,
  ...
  "GPA: 3.85/4
   \\begin{itemize}
     ...
     \\item Awards: Recipient of 4 years of scholarship as a Student-Athlete for Soccer in a NCAA Division 1 University
   \\end{itemize}") %>% 
...
tribble(~ Title, ~ Published, ~ Journal,  ~ Why, 
  ...
  detailed_entries(where = Published, with = Title, what = Journal, why = Why,
                   .protect = FALSE)
```
...
Italian (Intermidiate) & Bash (Basic)          & CSS (Intermidiate)    &  &  \\
